...
$CC $INCLUDES $BLAS_DEFS -O2 --coverage -frounding-math -fno-fast-math -ffp-contract=off -fPIC \
...
$CC $INCLUDES $BLAS_DEFS -O2 --coverage -frounding-math -fno-fast-math -ffp-contract=off -shared -fPIC \
